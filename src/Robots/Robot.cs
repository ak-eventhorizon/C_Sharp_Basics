...
namespace C_Sharp_Basics {
    ...
    // abstract - абстрактный класс, на его основании нельзя создавать объекты, он используется только в качестве родительского для других классов
    // содержит общий функционал для всех дочерних классов

    // sealed - от такого класса нельзя наследовать другие классы
