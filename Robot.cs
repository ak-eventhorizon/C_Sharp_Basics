...
namespace C_Sharp_Basics {
    ...
    // абстрактный класс - на его основании нельзя создавать объекты, он используется только в качестве родительского
    // для других классов, содержит общий функционал для всех дочерних классов
